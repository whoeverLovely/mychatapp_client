...
public class DBTest {
    ...
    private final Class mDbHelperClass = ChatAppDBHelper.class;
    ...
    public void create_database_test() throws Exception{
        ...
        Cursor tableNameCursor = database.rawQuery(
                "SELECT name FROM sqlite_master WHERE type='table' AND name='" +
                        ChatAppDBContract.MessageEntry.TABLE_NAME + "'",
                null);
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                ChatAppDBContract.MessageEntry.TABLE_NAME, tableNameCursor.getString(0));
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(ChatAppDBContract.MessageEntry.COLUMN_MESSAGE_CONTENT, "test content 1");
        testValues.put(ChatAppDBContract.MessageEntry.COLUMN_RECEIVER_ID, 1);
        testValues.put(ChatAppDBContract.MessageEntry.COLUMN_SENDER_ID, "hello");
        testValues.put(ChatAppDBContract.MessageEntry.COLUMN_STATUS, 0);
    ...
    public void autoincrement_test() throws Exception{
        ...
        testValues.put(ChatAppDBContract.MessageEntry.COLUMN_MESSAGE_CONTENT, "test content 1");
        testValues.put(ChatAppDBContract.MessageEntry.COLUMN_RECEIVER_ID, 1);
        testValues.put(ChatAppDBContract.MessageEntry.COLUMN_SENDER_ID, 2);
        testValues.put(ChatAppDBContract.MessageEntry.COLUMN_STATUS, 0);
